...
public class ResetTime extends MainActivity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			textView.setText("Please enter a time interval.");
		}
		else
		{
		    textView.setText("The alarm is set to check every: " + getStoredTime() + " minutes");
		}
